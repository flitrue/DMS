	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="alert alert-block alert-success col-xs-10">
					<button onclick="hiddenalert();" type="button" class="close" data-dismiss="alert">
				...
				<div class="row">
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-12 text-center" id="slidr-box">
							<div id="slidr-ul" style="margin: auto;">

								<div data-slidr="one" class="huandeng-box">
									<img class="huandeng" src="<?php echo (IMAGE_UPLOADURL); echo ($img[0]["url1"]); ?>">
								</div>

								<div data-slidr="two" class="huandeng-box">
									<img class="huandeng" src="<?php echo (IMAGE_UPLOADURL); echo ($img[0]["url2"]); ?>">
								</div>

								<div data-slidr="three" class="huandeng-box">
									<img class="huandeng" src="<?php echo (IMAGE_UPLOADURL); echo ($img[0]["url3"]); ?>">
								</div>
									...
									<div class="widget-header">
										...
										<div class="widget-toolbar no-border">
											<ul class="nav nav-tabs" id="recent-tab">
												<li class="active">
													<a data-toggle="tab" href="#member-tab">员工</a>
												</li>
												<li>
													<a data-toggle="tab" href="#device-tab">设备</a>
												</li>

												<!--<li>
													<a data-toggle="tab" href="#patent-tab">专利</a>
												</li>-->
											</ul>
										</div>
									</div>
										...
										<div class="widget-main padding-4">
											<div class="tab-content padding-8 overflow-visible">
												<div id="member-tab" class="tab-pane active">
													<?php if(is_array($memberlate)): $i = 0; $__LIST__ = $memberlate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><div class="itemdiv memberdiv">
															<div class="user">
																<img src="<?php echo ($vol["avatar"]); ?>" onerror="javascript:this.src='<?php echo (ASSETS_URL); ?>images/avatar.png'" alt="">
															</div>
															<div class="body">
																<div class="name">
																	<a href="<?php echo U('staff/detail');?>&uid=<?php echo ($vol["id"]); ?>"><?php echo ($vol["name"]); ?></a>
																</div>
																<div class="time">
																	<i class="icon-time"><?php echo (date('m月d日',strtotime($vol["time"]))); ?></i>
																	<span class="green"></span>
																</div>
															</div>
														</div><?php endforeach; endif; else: echo "" ;endif; ?>
												</div>
												<div id="device-tab" class="tab-pane">
													<ul class="item-list">
														<?php if(is_array($devicelate)): $i = 0; $__LIST__ = $devicelate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li class="item-orange chearfix">
																<label class="inline">
																	<span><a href="<?php echo U('device/detail');?>&did=<?php echo ($vol["id"]); ?>"><?php echo ($vol["name"]); ?></a></span>
																</label>
																<div class="pull-right">
																	<span><?php echo ($vol["buytime"]); ?></span>
																</div>
															</li><?php endforeach; endif; else: echo "" ;endif; ?>
													</ul>
												</div>

												<div id="patent-tab" class="tab-pane">
													<ul class="item-list">
														<?php if(is_array($patentlate)): $i = 0; $__LIST__ = $patentlate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li class="item-orange chearfix">
																<label class="inline">
										...
										<div class="widget-main no-padding">
											<div class="dialogs">
												<div class="itemdiv dialogdiv">
													<div id="usernumchart" style="height: 300px;">
...
<script src="<?php echo (JS_URL); ?>slidr.min.js"></script>
<script>
...
<script type="text/javascript">
	slidr.create('slidr-ul', {
		...
		overfloaw: true,
		touch: true
	}).add("h",["one","two","three","one"]).auto(3E3,"left");

	var usernumchart = echarts.init(document.getElementById('usernumchart'));
	var str = '<?php echo ($depart); ?>';
	var depart = eval(str);
	var membernum = eval('<?php echo ($menbernum); ?>');

	usernumchart.setOption(option = {
	...
	var bool = "<?php echo (cookie('dms_bool')); ?>";
	if(bool){
		$(".alert").hide();
	}
	function hiddenalert() {
		$.ajax({
			url: "<?php echo U('index/del_cookie');?>",
			success: function(){
			}
		});
	}

	$(".huandeng-box").width($('#slidr-box').width());
	$(".huandeng").width($('#slidr-box').width()* 0.95);
