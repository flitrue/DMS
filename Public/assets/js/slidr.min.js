...
function E() {
    ...
    function A() {
        for (var a = {}, b = 0, c; c = arguments[b]; b++)for (var d in c)a[d] = c[d];
        return a
    }
    ...
    function h(a, b) {
        if ("string" === typeof b) {
            var c = document.defaultView ? document.defaultView.getComputedStyle(a) : a.currentStyle, d = c[e.q(b)];
    ...
    var e = {
        J: ["webkit", "Moz", "ms", "O"], e: {}, T: {}, k: function () {
        ...
        Y: function (a, b, c) {
            a = C(a);
            for (var d = 0, g, f; g = e.cssRules()[d]; d++)if (f = C(g.name || g.selectorText || g.cssText.split(" {")[0] || ""), f === a) {
            ...
            if (!(a in e.e)) {
                ...
                if (void 0 !== e.ja[g])e.e[a] = {
                    t: a,
                    ca: g
                }; else for (g = c.join(""), d = 0; d < e.J.length; d++)void 0 !== e.ja[e.J[d] + g] && (e.e[a] = {
            ...
            fade: function (a, b, c) {
                e.O(a, {0: {opacity: b, visibility: "visible"}, 100: {opacity: c, visibility: "hidden"}})
                ...
                e.O(a, {
                    ...
                    100: {transform: "translate" + d[0] + "(0%)", opacity: "out" === b ? "0" : f, visibility: "hidden"}
                })
            }, cube: function (a,
                               b, c, d, g, f) {
                e.O(a, {
                    ...
                    100: {transform: "rotate" + c + "0deg) translateZ(" + d + "px)", opacity: f, visibility: "hidden"}
                })
            }
        }, $: function (a) {
            return {
        ...
        Z: ["cube", "fade", "linear", "none"], L: function (a, b) {
            b = b || a.d.transition;
        ...
        F: "left up top right down bottom".split(" "), H: function (a) {
            return 0 <= x(l.F, a)
        }, I: function (a) {
            var b = l.F.length;
            ...
            if (b && b !== a.c && l.get(a, b)) {
                var c = a.D[a.c], d = a.D[b], g = c.x < d.x ? "right" : c.x > d.x ? "left" : null, d = c.y < d.y ? "up" : c.y > d.y ? "down" : null, c = t.get(a, a.c, "out", g) ? g : t.get(a, a.c, "out", d) ? d : null, g = t.get(a, b, "in", g) ? g : t.get(a, b, "in", d) ?
                    d : null;
            ...
            for (var e = 0, n, h, k, m, p, q, r, s; n =
                b[e]; e++)if (!(n in d) || l.get(a, n) && (h = b[e - 1] || null, k = b[e + 1] || null, m = l.get(a, n, g), p = l.get(a, n, f), q = l.get(a, k, g), r = t.get(a, n, "out", g), s = t.get(a, n, "out", f), p && k && p != k || m && h && m != h || q && q != n || h && r && r != c || k && s && s != c))return !1;
            return !0
        ...
        b: e.$("control"),
        types: ["border", "corner", "none"], valid: function (a) {
            ...
            if (a.a && !a.controls) {
                ...
                for (var b in a.i) {
                    var c = a.i, d = b, g = v(y("div"), "add", m.b.i, b);
        ...
        b: e.$("breadcrumbs"),
        G: function (a) {
            a.a && !a.h && (a.h = h(v(y("aside", {id: p.b.id(a)}), "add", "disabled"), {
                opacity: "0",
                filter: "alpha(opacity=0)",
                "z-index": "0",
                "pointer-events": "none",
        ...
        t: function (a) {
            ...
            e.f(p.b.r + ".disabled", {transform: "translateZ(0px) !important"},
                !0);
        ...
        create: function (a) {
            p.G(a);
            if (a.h) {
                var b = {}, c = {x: {min: 0, max: 0}, y: {min: 0, max: 0}};
    ...
    var u = {
        G: function (a, b) {
            ...
            if (b.length)for (var d = 0, e, f; e = b[d]; d++)if (e.getAttribute("id")) {
        ...
        l: {}, ma: function (a) {
            ...
            var c = (z(b) ? k.Q(a.a) :
                    0) + 42, d = (z(b) ? k.P(a.a) : 0) + 42, e = h(b, "width"), f = h(b, "height"), l = h(b, "min-width"), n = h(b, "min-height"), c = {
        ...
        g: {
            ...
            w(a.a, "touchend", function (b) {
                ...
                if (250 > Number(+new Date - d)) {
                    var c = Math.abs(g), h = Math.abs(f), k = 20 < c, l = 20 < h, m = 0 > g ? "right" : "left", p = 0 > f ? "down" :
                        "up";
        ...
        start: function (a, b) {
            if (!a.u && a.a) {
                var c = h(a.a, "display"), d = h(a.a, "position"), e = h(a.a, "opacity");
                h(a.a, {
                    visibility: "visible",
                    opacity: e,
            ...
            if (a.a) {
                d = t.L(a, d);
                var f = l.find(a), h = "horizontal" === b || "h" === b ? "left" : "up", k = "horizontal" === b || "h" === b ? "right" : "down";
